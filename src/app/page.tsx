...
export default function RootPage() {
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* CTA */}
      <section className="bg-white py-10 flex flex-col items-center gap-4 text-center">
        <div className="w-28 h-28 rounded-full border-4 border-amber-500 bg-amber-50 flex flex-col items-center justify-center shadow-md">
        ...
        <p className="text-amber-600 font-bold text-base">まずはお気軽にお試しください！</p>
        <Link href="/register"
          className="inline-block mt-2 bg-amber-400 text-[#1e3a5f] font-black text-base px-8 py-3 rounded-full shadow hover:bg-amber-300 transition">
          今すぐ5分でカンタン登録！
        </Link>
      </section>
