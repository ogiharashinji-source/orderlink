...
const STEPS = [
  ...
  },
  {
    ...
    body: [
      ...
      "販売店は「新規登録」から手動で登録できるほか、QRコードや招待リンクを送って販売店自身に登録していただくこともできます。",
      "承認済みの販売店は、OrderLink上で受発注ができるようになります。",
    ],
    image: "/manual/step2.png",
    imageAlt: "顧客管理画面",
    highlights: ["QRコードボタン：販売店へ招待リンクを共有", "新規登録ボタン：手動で販売店情報を入力", "承認：販売店を有効化します"],
  },
  {
    id: "step3",
    num: 3,
...
export default function ManualPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans print:bg-white">
      {/* ヘッダー */}
      <header className="bg-[#1e3a5f] text-white py-10 px-6 print:py-6">
