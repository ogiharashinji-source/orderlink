    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 print:bg-white print:py-4">
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <div className="bg-blue-700 text-white rounded-xl p-8">
          <p className="text-blue-200 text-sm mb-1">OrderLink</p>
          <h1 className="text-3xl font-bold">ポータル会員向け操作マニュアル</h1>
          <p className="text-blue-200 text-sm mt-2">販売店・取引先担当者向け</p>
        </div>
